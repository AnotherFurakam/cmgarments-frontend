...
import { IGetAll, IPurchaseDetail } from "@/models/purchase-detail.interface";

//? crear compra
const create = async (body: IPurchaseDetail): Promise<IPurchaseDetail> => {
